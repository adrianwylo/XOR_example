...
func _on_solution_display_solution(solution_pieces: Variant, position_dictionary: Variant) -> void:
	for polygon in solution_pieces:
		shape_create(polygon, position_dictionary)
